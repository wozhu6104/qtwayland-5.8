...
protected:
    void ivi_application_surface_create(Resource *resource, uint32_t ivi_id, wl_resource *surface,
                                        const QString &window_title, uint32_t zorder, uint32_t id) Q_DECL_OVERRIDE;
};
